            ...
            <div class="bg-light p-5 rounded">
                <div class="row g-4 justify-content-center">
                    @php
                        ...
                        // Mengambil jumlah customer dari tabel users dengan role 'customer'
                        $totalCustomers = User::where('role', 'customer')->count();

                        // Mengambil jumlah produk dari tabel products
                        $totalProducts = Produk::count();

                         // Mengambil rata-rata rating dari tabel ulasan
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="counter bg-white rounded p-5">
                            ...
                            <h1>{{ number_format($averageRating, 2) }}</h1>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="counter bg-white rounded p-5">
        ...
        <div class="container py-5">
            ...
            <div class="owl-carousel testimonial-carousel">
                @php
                    ...
                    // Mengambil ulasan dari tabel store_reviews
                    $reviews = StoreReview::all();
                @endphp
